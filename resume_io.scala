...
mouseEntered(e: MouseEvent) =
 ...
 t2.setForeground(new Color(109, 99, 99))
        t2.setText("e.g\nGoogle or Microsoft - Chief Executive Officer - \nGoogle or Microsoft - Software Engineer\nAny Local - Software Engineer\nMaxgen Technologies Pvt .Ltd - Software Engineer\nMaxgen Technologies Pvt .Ltd Intern")
